...
export default function Header() {
    return(
        <View style={{backgroundColor:'#1C1C1C', width:'100%',paddingHorizontal:20, height:60, flexDirection:'row',justifyContent:'space-between',alignItems:"center", marginTop:30, marginBottom:3}}>
